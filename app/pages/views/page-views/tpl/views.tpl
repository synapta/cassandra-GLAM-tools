	...
	<div class="list_item" data-imagename="{{img_name}}">
		<div class="row">
			...
			<div class="item col-4">
				<div class="row">
					<div class="col-2">
						<span style="font-size: 0.6em; text-transform: uppercase;">§[messages.total]§</span>
					</div>
				...
				<div class="row">
					<div class="col-2">
						<span style="font-size: 0.6em; text-transform: uppercase;">§[messages.avg-day]§</span>
					</div>
					<div class="col-8" style="font-family: 'Lato', sans-serif; text-align:right; display:inline">
						{{av}}
					</div>
				...
				<div class="row">
					<div class="col-2">
						<span style="font-size: 0.6em; text-transform: uppercase;">§[messages.median]§</span>
					</div>
					<div class="col-8" style="font-family: 'Lato', sans-serif; text-align:right; display:inline">
						{{median}}
					</div>
