      ...
      if (res.nodes) {
        ...
        if (urlSplit[5]) {
          let ref =
            ...
            urlSplit[4] +
            "/" +
            decodeURIComponent(urlSplit[5]) +
            "/" +
            (urlSplit[6] ? decodeURIComponent(urlSplit[6]) : "");
          categories.push(ref);
          opts +=
            "<option>" + decodeURIComponent(urlSplit[5]).replace(/[_\-]+/g, " ") + "</option>";
        }
        ...
        $(".autocomplete-categories").on("change", el => {
          if (
            el &&
            el.currentTarget &&
            el.currentTarget.selectedIndex &&
            categories[el.currentTarget.selectedIndex]
          ) {
